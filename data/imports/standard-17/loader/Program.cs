...
var source="data/imports/standard-17/standard-17.extracted.json";
...
var sid=await Insert("standards","standardId",new(){["standardNumber"]="17",["standardTitle"]=S(data,"standardTitle"),["standardSummary"]=S(data,"standardSummary"),["componentId"]=component,["functionId"]=function});
...
if(expected.Count!=21)throw new Exception("Unexpected record count");
...
var receipt=new{standardId=sid,componentId=component,functionId=function,criteria=3,compliances=4,evidence=13,verifiedRecords=expected.Count,importedAt=DateTimeOffset.UtcNow};
File.WriteAllText("data/imports/standard-17/import-receipt.json",JsonSerializer.Serialize(receipt,new JsonSerializerOptions{WriteIndented=true}));
