...
OUT=Path('data/imports/standards-23g-l');NS={'w':'http://schemas.openxmlformats.org/wordprocessingml/2006/main'};W='{'+NS['w']+'}'
def roman(n):
 s=''
...
for L in 'GHJKL':
 ...
 titles={'G':'Otorhinolaryngology (ear, nose and throat)','H':'Radiology','J':'Operating theatre','K':'Intensive care unit (ICU) / High dependency unit (HDU)','L':'Central supply sterilising department (CSSD)'}
 data['standardTitle']=titles[L]
 if L=='G':data['notes'].append('Corrected the title typo EAR, NOTE & THROAT to ear, nose and throat.')
