...
import json
P=Path('data/imports/standards-24-25');data=json.loads((P/'batch.json').read_text(encoding='utf-8'))
...
notes=['# Standards 24–25 import review','Function 4; Component 6. Source documents unmodified.','Criterion guidance and source references retained in standard summaries. Automatic Word list labels rendered as text; bullet glyphs normalized. Assessment columns and repeated summary sheets excluded.']
for d in data:
