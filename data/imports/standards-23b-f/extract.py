...
OUT=Path('data/imports/standards-23b-f');NS={'w':'http://schemas.openxmlformats.org/wordprocessingml/2006/main'};W='{'+NS['w']+'}'
def roman(n):
 s=''
...
for L in 'BCDEF':
 ...
 for rn,row in enumerate(tables[1][6:],6):
  if len(row)==2 and re.fullmatch(r'23[a-z]\.\d+',row[0]):
   ...
   fixes={('B',162):'23b.4.9',('B',177):'23b.4.10',('C',144):'23c.4.4',('C',171):'23c.4.9',('D',32):'23d.2.1'}
   if (L,rn) in fixes:
