...
function MetricCard({ to, marker, label, count, loading, description, tone, accent, footer = "Open directory", detail }) {
  return <Link to={to} className={`group flex min-h-[224px] flex-col rounded-xl border border-[#e2ecea] border-t-4 ${accent} bg-white p-5 shadow-[0_8px_24px_rgba(20,60,66,0.06)] transition duration-200 hover:-translate-y-0.5 hover:border-[#8bc8be] hover:shadow-[0_14px_28px_rgba(8,124,119,0.12)]`}>
